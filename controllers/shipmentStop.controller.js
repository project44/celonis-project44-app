  ...
  if(shipment.routeInfo && shipment.routeInfo.stops && shipment.routeInfo.stops.length > 0 ) {
    for( const stop of shipment.routeInfo.stops) {
      var s = {
        ...
        location_name: stop.location ? stop.location.name : null,
        address_line_1: stop.location && stop.location.address ? stop.location.address.addressLines[0] || null : null,
        address_line_2: stop.location && stop.location.address ? stop.location.address.addressLines[1] || null : null,
        address_line_3: stop.location && stop.location.address ? stop.location.address.addressLines[2] || null : null,
        city: stop.location && stop.location.address && stop.location.address ? stop.location.address.city || null : null,
        state: stop.location && stop.location.address && stop.location.address ? stop.location.address.state || null : null,
