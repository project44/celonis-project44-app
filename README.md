...
| CRON_SCHEDULE | Configures a cron job to batch process sending jobs to Celonis. The default is to run every 15 minutes - '*/15 * * * *'. It is not recommended that this run less frequent. |
